...
<!DOCTYPE html>
<html>
<title>Compte parent Envoi</title>
<meta charset="UTF-8">
...
<?php 
      include_once 'index_parent_envoi.php';
    ?>
<!-- Page Container -->
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <br/>
         ...
         <p class="w3-small"><b><i class="fa fa-user fa-fw w3-margin-right w3-text-teal"></i><a href="#?id=<?php echo ($_SESSION['id']);?>" target="_parent" class="w3-padding-large w3-hover-white" style="text-decoration:none;">Information</a></b></p>
         <p class="w3-small"><b><i class="fa fa-book fa-fw w3-margin-right w3-text-teal"></i><a href="#?id=<?php echo ($_SESSION['id']);?>" target="_parent" class="w3-padding-large w3-hover-white" style="text-decoration:none;">Evenements</a></b></p>
         <p class="w3-small"><b><i class="fa fa-graduation-cap fa-fw w3-margin-right w3-text-teal"></i><a href="#?id=<?php echo ($_SESSION['id']);?>" target="_parent" class="w3-padding-large w3-hover-white" style="text-decoration:none;">Evolution du payement d'un étudiant</a></b></p>
         <hr>
