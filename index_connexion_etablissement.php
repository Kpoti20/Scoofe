...
<!-- Container (Services Section) -->
  ...
  <div class="row">
    <div class="col-sm-4">
      <span style="color: #009688; " class="glyphicon glyphicon-globe logo slideanim"></span>
    </div>
    <div class="col-sm-8">
      <h2>PARENTS</h2><br>
...
<!-- Container (Portfolio Section) -->
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2>Connexion au compte Etablissement</h2><br>
       <form method="POST" action="<?php echo htmlspecialchars("index_connexion_etablissement.php");?>">
    <div class="form-group">
      <label for="email">Email:</label>
      <input type="email" class="form-control" id="email" style="width:500px;" name="mailconnect" placeholder="Entrer le mail">
    </div>
    <div class="form-group">
      <label for="pwd">Password:</label>
      <input type="password" class="form-control" id="pwd" style="width:500px;" name="mdpconnect" placeholder="Entrer le mot de passe">
    </div>
    <div class="checkbox">
      <label><input type="checkbox"> Remember me</label>
    </div>
       <button type="submit" name="formconnexion" class="btn btn-success">Se connecter</button>
