          ...
          if(filter_var($mail,FILTER_VALIDATE_EMAIL))
          {
            ...
            { 
              ...
              if($mdpe == $mdp23)
              {
                ...
                "<br/>";
                $erreur="votre compte a ete cree avec succes! <a href=\"connexion.php\">Me connecter</a>"; 
              }
              else
              {
...
<body>
<?php 
      include_once 'inscription_parent_inscription.php';
    ?>
<!-- Navbar -->
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>PARENTS</h1>
      <h5 class="w3-padding-32">En vue d’atteindre l’objectif de MyScoofe, tout tuteur ou parent désirant  suivre l’évolution du payement de scolarité de son ou ses  étudiant(s)  a l’obligation de créer un compte parent.</h5>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <form class="w3-container w3-light-grey" method="POST" action="<?php echo htmlspecialchars("inscription_parent_inscription.php");?>"  >
      <p>
