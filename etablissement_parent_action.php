...
<!DOCTYPE html>
<html>
<title>Template Parent Action</title>
<meta charset="UTF-8">
...
<?php 
      include_once 'etablissement_parent_action.php';
    ?>
<!-- Page Container -->
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <?php
      ...
      <?php   
        ...
        ?>
  <p class="w3-medium" style="margin-left:1150px;"><b><i class="fa fa fa-arrow-left fa-fw w3-margin-right w3-text-teal"></i><a href="etablissement_parent.php?id=<?php echo ($_SESSION['id']);?>" target="_parent" class="w3-padding-2" style="text-decoration:none;">Retour Parent</a></b></p>
