        ...
        <div class="w3-container">
          ...
          <div class="w3-content">
            <form method="POST" action="">
              ...
              <input class="w3-input "  autocomplete="off" type="text" value="<?php if (isset($nom)) { echo $nom; } ?>" placeholder="Le nom de la classe" id="nom" name="nom"></p>
              <p>
              <label for="des" >Description</label>
              <input class="w3-input" type="text"  value="<?php if (isset($des)) { echo $des; } ?>" autocomplete="off" placeholder="La description de la classe" id="des" name="des"  ></p>
              <button  type="submit" class="btn btn-success"  name="forminscription" value="Sauvegarder" >Sauvegarder</button>
              <button  type="reset"  class="btn btn-warning"  name="" value="Sauvegarder" >Annuler</button>
            </form><br/>
            <?php
      if (isset($erreur))
      {?>
...
?>    
      <tr>
        ...
        <td>
       <a href="etablissement_classe_action.php?idfil=<?php echo $s->idfil;?>" target="_parent"  style="text-decoration:none;">Action</a></td>
		     <?php
                    }
                    ?>
