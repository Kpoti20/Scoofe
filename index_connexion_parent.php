...
{
  $pseudoconnect= htmlspecialchars($_POST['pseu']);
  $mdpconnect= sha1($_POST['mdp']);
  if (!empty($pseudoconnect) AND !empty($mdpconnect)) {
    //echo "BJ";
    $requser = $bdd->prepare("SELECT * FROM tuteur WHERE pseudo = ? AND motdepasse = ? ");
    $requser->execute(array($pseudoconnect,$mdpconnect));
    $userexisttu=$requser->rowCount();
    if ($userexisttu==1) {
      ...
      header("location:index_parent_reception.php?id=".$_SESSION['id']);
    }else{
...
<!-- Container (Services Section) -->
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2>CONNEXION PARENTS</h2><br>
      <form method="POST" action="">
    <div class="form-group">
      <label for="pseu">Pseudo:</label>
      <input type="text" class="form-control" id="pseu" name="pseu" placeholder="Enter votre pseudo">
    </div>
    <div class="form-group">
    ...
    <button type="submit" name="formconnexion" class="w3-btn w3-teal">Se connecter</button> <button type="reset" class="w3-btn w3-teal">Annuler</button>   <a  href="index.php"  class="wt">Retour</a>
  </form><br>
			 <?php
      if (isset($erreur))
      {?>
