...
<div id="te" class="w3-top">
  <ul  class="w3-navbar w3-blue w3-card-2 w3-left-align w3-large">
    ...
    <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-hover-white">PARENTS</a></li>
  ...
  <div  id="navDemo" class="w3-hide w3-hide-large w3-hide-medium">
    <ul class="w3-navbar w3-left-align w3-large w3-blue">
      ...
      <li><a class="w3-padding-large" href="inscription_parent.php">PARENTS</a></li>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>A PROPOS</h1>
      <h5 class="w3-padding-32">MyScoofe crée depuis le début de l’année 2018 est une plateforme de réseau social.  La plateforme est spécialement conçue pour les établissements d’enseignement supérieurs et les parents d’étudiants.</h5>

      <p class="w3-text-grey">MyScoofe met à la disposition des parents d’étudiants la possibilité de suivre les payements de scolarités de leurs enfants. En ce qui concerne les établissements d’enseignement supérieurs la plateforme est un excellent moyen d’être en contact direct avec les parents d’étudiants et également  suivre l’évolution du payement de scolarité de chaque étudiant.</p>
    </div>
