    ...
    if($pseudolength <= 255)
    {
      if (preg_match("/^[a-zA-Z ]*$/",$pseudo)) 
      {
        if($mail == $mail2)
        {
          ...
          {
            $reqmail=$bdd->prepare("SELECT * FROM tuteur WHERE mail = ? ");
            ...
            { 
              ...
              if($mdpe == $mdp23)
              {
                $insertmbr = $bdd->prepare("INSERT INTO tuteur(pseudo,mail,motdepasse) VALUES(?,?,?)");
...
<div style="  background-color: teal; " class="jumbotron text-center">
  <h1></h1> 
...
<div id="about" class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-4">
      <span style="color: teal; "  class="glyphicon glyphicon-signal logo"></span>
    </div>
  </div>
</div>
...
<!-- Container (Services Section) -->
  ...
  <div class="row">
    <div class="col-sm-4">
      <span style="color: teal; " class="glyphicon glyphicon-user logo slideanim"></span>
    </div>
    <div class="col-sm-8">
      <h2>INSCRIPTION PARENTS</h2><br>
      <form class="w3-container w3-light-grey" method="POST" action="<?php echo htmlspecialchars("index_inscription_parent.php");?>"  >
      <p>
      ...
      <button  type="submit" class="w3-btn w3-teal" name="forminscription" >S'inscrire</button>  <button  type="reset" class="w3-btn w3-teal" name="forminscription" >Annuler</button>  <a  href="index.php"  class="w3-btn w3-teal">Retour</a>
    </form><br>
			 <?php
      if (isset($erreur))
      {?>
